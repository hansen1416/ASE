...
_key_body_ids = torch.tensor(range(24), device=device)
...
rg_pos, rb_rot, body_vel, body_ang_vel = motion_res["rg_pos"], motion_res["rb_rot"], motion_res["body_vel"], motion_res["body_ang_vel"]
